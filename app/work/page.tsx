...
const projects = [
  { id: 13, latestOrder: 1, client: "SecurityPal", title: "Analytics Launch", tags: ["Security", "SaaS"], type: "Feature Launch", deliverable: "Feature launch → product + social", color: "#101418", videoId: "qw6B9nfV_kU", isLatest: true, caseUrl: "/case-studies/securitypal-case", showCase: true, modal: { label: "Feature Launch", title: "SecurityPal — Analytics Launch", desc: "Feature launch film for SecurityPal AI's new Analytics dashboard — surfacing SLA adherence, time saved, and revenue accelerated. Built to help customers show impact internally and drive team-wide adoption.", stats: [{ n: "Feature Launch", l: "Format" }, { n: "Product + Social", l: "Placement" }, { n: "Team Adoption", l: "Goal" }] } },
  { id: 1, latestOrder: 4, client: "SecurityPal", title: "Vision", tags: ["Security", "SaaS"], type: "Brand Film", deliverable: "Brand film → vision + sales", color: "#101418", videoId: "azDJfHvwpEY", isLatest: false, caseUrl: "/case-studies/securitypal-case", showCase: true, modal: { label: "Brand Film", title: "SecurityPal — Vision", desc: "A brand film capturing SecurityPal's vision — collapsing 20 minutes of sales explanation into a single buyer-clear asset. Built for decks, homepage, and enterprise outreach.", stats: [{ n: "14 days", l: "Delivery" }, { n: "90s", l: "Runtime" }, { n: "Enterprise", l: "Pipeline" }] } },
  { id: 2, latestOrder: 2, client: "SecurityPal", title: "2025 Year in Review", tags: ["Security", "SaaS"], type: "Brand Film", deliverable: "Year in review → brand + team", color: "#0d1218", videoId: "yTIf7xgYBtE", isLatest: false, caseUrl: "/case-studies/securitypal-review", showCase: true, modal: { label: "Brand Film", title: "SecurityPal — 2025 Year in Review", desc: "A brand retrospective capturing SecurityPal's 2025 milestones. Built to resonate with team, clients, and the broader security community.", stats: [{ n: "Year in Review", l: "Format" }, { n: "Brand + Team", l: "Placement" }, { n: "Community", l: "Audience" }] } },
  { id: 3, latestOrder: 3, client: "SecurityPal", title: "2025 Year in Review Shorts", tags: ["Security", "SaaS"], type: "Short", deliverable: "Short-form → social + brand", color: "#0d1318", videoId: "dx_cVOzQsw8", isLatest: false, caseUrl: "/case-studies/securitypal-shorts", showCase: true, modal: { label: "Short", title: "SecurityPal — 2025 Year in Review Shorts", desc: "Short-form cuts from the 2025 Year in Review, built for social distribution and brand storytelling.", stats: [{ n: "Short", l: "Format" }, { n: "Social", l: "Distribution" }, { n: "Outbound", l: "Also used" }] } },
  { id: 4, latestOrder: 8, client: "Aleph", title: "Funding Film", tags: ["Fintech", "SaaS"], type: "Launch Film", deliverable: "Launch film → Series B announcement", color: "#0d1018", videoId: "7sbP3rOhPec", isLatest: false, caseUrl: "/case-studies/aleph-case", showCase: true, modal: { label: "Launch Film", title: "Aleph — Funding Announcement Film", desc: "Authority-first announcement video delivered on a fast track. Built to land with investors, press, and future hires simultaneously.", stats: [{ n: "7 days", l: "Fast-track" }, { n: "Hero + cutdowns", l: "Package" }, { n: "Press + hiring", l: "Used in" }] } },
  { id: 5, latestOrder: 5, client: "DocUnlock", title: "How It Works", tags: ["AI", "TradeOps"], type: "Explainer", deliverable: "Explainer → how DocUnlock works", color: "#0d1018", gif: "https://framerusercontent.com/images/yNs8rP2D4soCiX7eNIR9FJp3zI.gif", videoId: "0WjL6oWzHUg", isLatest: false, caseUrl: "/case-studies/docunlock-case", showCase: true, modal: { label: "Case Study", title: "DocUnlock — How It Works", desc: "A clear walkthrough of how DocUnlock automates customs documentation. Built to make a complex compliance workflow instantly legible to skeptical buyers.", stats: [{ n: "14 days", l: "Delivery" }, { n: "Hero + cutdowns", l: "Package" }, { n: "Landing + sales", l: "Used in" }] } },
  { id: 6, latestOrder: 11, client: "Thera", title: "Time Tracking", tags: ["Fintech", "HR Tech"], type: "Launch Video", deliverable: "Launch video → product + sales", color: "#0f1210", videoId: "9HL6ZAzvzRo", isLatest: false, caseUrl: "", showCase: false, modal: { label: "Launch Video", title: "Thera — Time Tracking", desc: "Launch video for Thera's time tracking feature. Built to make a nuanced payroll capability immediately clear to buyers.", stats: [{ n: "90s", l: "Runtime" }, { n: "Outbound", l: "Distribution" }, { n: "Sales", l: "Used in" }] } },
  { id: 7, latestOrder: 12, client: "Thera", title: "For Startups", tags: ["Fintech", "HR Tech"], type: "Launch Video", deliverable: "Launch video → sales + social", color: "#0f1210", videoId: "kT00CUHWrBU", isLatest: false, caseUrl: "", showCase: false, modal: { label: "Launch Video", title: "Thera — For Startups", desc: "Launch video positioning Thera as the payroll and compliance layer for startup teams. Built for sales and social distribution.", stats: [{ n: "90s", l: "Runtime" }, { n: "Series", l: "Format" }, { n: "Outbound", l: "Distribution" }] } },
  { id: 8, latestOrder: 9, client: "Polymet", title: "Product Revamp", tags: ["AI", "DevTools"], type: "Launch Video", deliverable: "Launch video → product revamp + web", color: "#0d100d", videoId: "aEPXSjIqeBc", isLatest: false, caseUrl: "", showCase: false, modal: { label: "Launch Video", title: "Polymet — Product Revamp", desc: "Launch video for Polymet's product revamp. Built to reintroduce the product with clarity and visual energy.", stats: [{ n: "Launch Film", l: "Format" }, { n: "Web + Social", l: "Placement" }, { n: "Product-led", l: "Approach" }] } },
  { id: 9, latestOrder: 10, client: "Orchids", title: "Editor", tags: ["AI", "DevTools"], type: "Launch Video", deliverable: "Launch video → product + web", color: "#12100d", videoId: "W0ZV1xQuxlE", isLatest: false, caseUrl: "", showCase: false, modal: { label: "Launch Video", title: "Orchids — Editor", desc: "Launch video for Orchids' AI-powered editor. Built to make the product's core value tangible for developers and early adopters.", stats: [{ n: "Brand", l: "Format" }, { n: "Web + Social", l: "Placement" }, { n: "Emotion-led", l: "Approach" }] } },
  { id: 10, latestOrder: 13, client: "reAlpha", title: "Launch in Various States", tags: ["AI", "RealTech"], type: "Launch Video", deliverable: "Launch video → expansion + growth", color: "#0d1410", videoId: "owlpeuLqyA0", isLatest: false, caseUrl: "", showCase: false, modal: { label: "Launch Video", title: "reAlpha — Launch in Various States", desc: "Launch video announcing reAlpha's expansion into new US markets. Built to communicate momentum to buyers and partners.", stats: [{ n: "Demo", l: "Format" }, { n: "Investor", l: "Primary use" }, { n: "Outbound", l: "Also used" }] } },
  { id: 11, latestOrder: 14, client: "reAlpha", title: "Feature Walkthrough", tags: ["AI", "RealTech"], type: "Explainer", deliverable: "Feature clarity → landing + sales", color: "#0f1410", videoId: "SIjttWc0HnU", isLatest: false, caseUrl: "", showCase: false, modal: { label: "Explainer", title: "reAlpha — Feature Walkthrough", desc: "A clean feature walkthrough built to make an AI real estate product immediately legible to buyers. Designed for landing page and sales reuse.", stats: [{ n: "Explainer", l: "Format" }, { n: "Landing", l: "Placement" }, { n: "Sales", l: "Also used" }] } },
  { id: 14, latestOrder: 6, client: "Niural AI", title: "Canada Launch", tags: ["AI", "HR Tech"], type: "Launch Video", deliverable: "Launch video → Canada market expansion", color: "#0d0f18", videoId: "qC7YyUs9YNA", isLatest: false, caseUrl: "", showCase: false, modal: { label: "Launch Video", title: "Niural AI — Canada Launch", desc: "Launch video for Niural AI's expansion into the Canadian market. Built to communicate compliance-first payroll to a new audience fast.", stats: [{ n: "Product", l: "Format" }, { n: "Landing", l: "Placement" }, { n: "Sales", l: "Also used" }] } },
  { id: 15, latestOrder: 7, client: "Wisprflow", title: "Spec Animation", tags: ["AI", "DevTools"], type: "Spec Film", deliverable: "Spec animation → concept + portfolio", color: "#0a0d14", videoId: "cGqUjnGyqs0", isLatest: false, caseUrl: "", showCase: false, modal: { label: "Spec Film", title: "Wisprflow — Spec Animation", desc: "A spec animation exploring how Wisprflow's voice-to-text AI could be brought to life visually. Built as a concept piece demonstrating motion-led product storytelling.", stats: [{ n: "Spec", l: "Format" }, { n: "Concept", l: "Type" }, { n: "Motion-led", l: "Approach" }] } },
  { id: 16, latestOrder: 16, client: "reAlpha", title: "Content Video", tags: ["AI", "RealTech"], type: "Content Video", deliverable: "Content video → social + brand", color: "#0d0d0d", videoId: "xRGp8VLp8Us", isLatest: false, caseUrl: "", showCase: false, modal: { label: "Content Video", title: "reAlpha — Content Video", desc: "A content-led video for reAlpha's AI real estate platform. Built to communicate the product's value in an approachable, social-native format.", stats: [{ n: "Content", l: "Format" }, { n: "Social", l: "Placement" }, { n: "Story-led", l: "Approach" }] } },
  { id: 12, latestOrder: 15, client: "Openmart", title: "Brand Video", tags: ["AI", "LeadGen"], type: "Brand Film", deliverable: "Brand clarity → landing + outbound", color: "#130d18", videoId: "kfTweR2Q6fg", isLatest: false, caseUrl: "", showCase: false, modal: { label: "Brand Film", title: "Openmart — Brand Video", desc: "Brand clarity film for a B2B lead generation platform. Built to make a complex product feel immediately legible to buyers.", stats: [{ n: "Brand", l: "Format" }, { n: "Landing", l: "Placement" }, { n: "Outbound", l: "Also used" }] } },
];
    ...
    <div style={{ background: "#0a0a0a", minHeight: "100vh", color: "#f2f2f2", fontFamily: "var(--font-bricolage), system-ui, sans-serif" }}>
      ...
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, padding: "0 28px", height: "60px", display: "flex", alignItems: "center", justifyContent: "space-between", borderBottom: "1px solid rgba(255,255,255,0.06)", background: "rgba(10,10,10,0.88)", backdropFilter: "blur(12px)" }}>
        ...
        <Link href="/" style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: "6px" }}>
          ...
          <span style={{ fontFamily: "var(--font-dm)", fontSize: "11px", fontWeight: 400, color: "rgba(255,255,255,0.25)" }}>Studio</span>
        </Link>
        {/* BACK LINK — Bricolage */}
      ...
      <section id="recent-work" style={{ paddingTop: "60px", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
        <div style={{ padding: "100px 28px 120px", maxWidth: "1160px", margin: "0 auto" }}>
          ...
          <div ref={headerRef} style={{ marginBottom: "56px" }}>
            ...
            {/* FILTER TABS — Bricolage */}
            <div className="h-el" style={{ opacity: 0, display: "flex", gap: "8px", flexWrap: "wrap" }}>
              {ALL_TAGS.map(tag => {
                const isSpecial = tag === "Latest", isActive = active === tag;
                return (
                  <button key={tag} onClick={() => setActive(tag)} style={{
                    fontFamily: "var(--font-bricolage)", padding: "7px 16px", borderRadius: "999px",
                    border: isActive ? "1px solid rgba(255,255,255,0.3)" : isSpecial ? "1px solid rgba(255,255,255,0.14)" : "1px solid rgba(255,255,255,0.08)",
                    background: isActive ? "rgba(255,255,255,0.08)" : isSpecial ? "rgba(255,255,255,0.04)" : "transparent",
                    color: isActive ? "rgba(255,255,255,0.82)" : isSpecial ? "rgba(255,255,255,0.5)" : "rgba(255,255,255,0.32)",
                    fontSize: "12.5px", fontWeight: isActive ? 500 : 300,
                    cursor: "pointer", transition: "all 0.18s ease", letterSpacing: "0.01em",
                  }}
                  onMouseEnter={e => { if (!isActive) { (e.currentTarget as HTMLButtonElement).style.borderColor = "rgba(255,255,255,0.22)"; (e.currentTarget as HTMLButtonElement).style.color = "rgba(255,255,255,0.65)"; } }}
                  onMouseLeave={e => { if (!isActive) { (e.currentTarget as HTMLButtonElement).style.borderColor = isSpecial ? "rgba(255,255,255,0.14)" : "rgba(255,255,255,0.08)"; (e.currentTarget as HTMLButtonElement).style.color = isSpecial ? "rgba(255,255,255,0.5)" : "rgba(255,255,255,0.32)"; } }}>
                    {tag}
                  </button>
                );
              })}
          ...
          <div style={{ marginTop: "80px", paddingTop: "48px", borderTop: "1px solid rgba(255,255,255,0.06)", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "24px" }}>
            <div>
              {/* "Seen enough?" — DM Sans */}
              <p style={{ fontFamily: "var(--font-dm)", fontSize: "18px", fontWeight: 700, color: "rgba(255,255,255,0.7)", letterSpacing: "-0.02em", margin: "0 0 6px" }}>Seen enough?</p>
              {/* SUBLINE — Bricolage */}
