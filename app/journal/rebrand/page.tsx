  ...
  return (
    <main style={{ background: "radial-gradient(ellipse 900px 600px at 20% 10%, #141414 0%, #0a0a0a 40%, #080808 100%)", minHeight: "100vh", color: "#f0f0f0", fontFamily: "var(--font-bricolage), system-ui, sans-serif", overflowX: "hidden" }}>
      ...
      <section style={{ minHeight: "100vh", display: "flex", alignItems: "center", position: "relative", overflow: "hidden", paddingTop: "60px" }}>
        ...
        <div ref={heroRef} style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 28px", position: "relative", zIndex: 2, width: "100%" }}>
          ...
          <div className="hero-el" style={{ opacity: 0, marginBottom: "40px" }}>
            <img
              src="/tanoseilogos/logo.png"
              alt="Tanosei Mark"
              style={{ width: "64px", height: "64px", objectFit: "contain", borderRadius: "14px", border: "1px solid rgba(255,255,255,0.10)", background: "rgba(255,255,255,0.03)", padding: "10px" }}
            />
          </div>
          ...
          {/* Headline — now full width */}
          <h1 className="hero-el" style={{ opacity: 0, fontFamily: "var(--font-dm)", fontSize: "clamp(52px, 9vw, 120px)", fontWeight: 900, letterSpacing: "-0.045em", lineHeight: 0.93, margin: "0 0 40px" }}>
            <span style={{ color: "#ffffff" }}>The</span>
            <br />
            <span style={{ color: "#ffffff" }}>Geometric</span>
            <br />
            <span style={{ color: "rgba(255,255,255,0.45)", fontWeight: 300 }}>Rebirth.</span>
          </h1>
          ...
          <div className="hero-el" style={{ opacity: 0, display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexWrap: "wrap", gap: "32px", maxWidth: "900px" }}>
            ...
            <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
              {(["○", "△", "□"] as const).map((s, i) => (
                <button key={i} onClick={() => {
                ...
                }} style={{ width: "48px", height: "48px", border: "1px solid rgba(255,255,255,0.18)", borderRadius: "10px", display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(255,255,255,0.05)", cursor: "pointer", transition: "all 0.2s" }}
                  onMouseEnter={e => { (e.currentTarget as HTMLButtonElement).style.background = "rgba(255,255,255,0.12)"; (e.currentTarget as HTMLButtonElement).style.borderColor = "rgba(255,255,255,0.35)"; }}
                  ...
                  <span style={{ fontFamily: "var(--font-dm)", fontSize: "20px", color: "rgba(255,255,255,0.65)" }}>{s}</span>
                </button>
              ))}
              <span style={{ fontFamily: "var(--font-bricolage)", fontSize: "11px", fontWeight: 300, color: "rgba(255,255,255,0.20)", marginLeft: "6px", letterSpacing: "0.08em" }}>Visual Synthesis</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 28px 100px" }}>
        ...
        <div style={{ width: "100%", aspectRatio: "16 / 9", borderRadius: "18px", overflow: "hidden", border: "1px solid rgba(255,255,255,0.10)", background: "#000", position: "relative" }}>
          <iframe
            src="https://www.youtube.com/embed/c1AJKi7gANA?modestbranding=1&rel=0&color=white"
      ...
      <div ref={bodyRef} style={{ maxWidth: "780px", margin: "0 auto", padding: "0 28px 140px" }}>
        ...
        <div id="visual-synthesis" className="fade-in" style={{ opacity: 0, marginBottom: "80px" }}>
          ...
          <p style={{ fontFamily: "var(--font-bricolage)", fontSize: "15px", fontWeight: 300, color: "rgba(255,255,255,0.45)", lineHeight: 1.8, margin: "0 0 28px", textAlign: "center" }}>Three foundational forms. Three distinct forces. One shared system.</p>
        ...
        <div className="fade-in" style={{ opacity: 0, marginBottom: "80px" }}>
          ...
          <div style={{ marginTop: "32px" }}>
            ...
            <div style={{ borderRadius: "14px", overflow: "hidden", border: "1px solid rgba(255,255,255,0.10)", background: "#0d0d0d" }}>
              <img src="/tanoseilogos/logo_form.png" alt="Tanosei Mark Formation" style={{ width: "100%", display: "block", filter: "brightness(1.8) contrast(1.1)" }} />
            </div>
          </div>
        </div>
        ...
        <div className="fade-in" style={{ opacity: 0, marginBottom: "80px" }}>
          <div style={{ padding: "36px", border: "1px solid rgba(255,255,255,0.09)", borderRadius: "18px", background: "rgba(255,255,255,0.02)" }}>
            ...
            <h3 style={{ fontFamily: "var(--font-dm)", fontSize: "22px", fontWeight: 800, letterSpacing: "-0.04em", color: "#ffffff", margin: "0 0 14px" }}>Built to adapt. Designed to stay coherent.</h3>
        ...
        <div className="fade-in" style={{ opacity: 0, marginBottom: "80px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "12px" }}>
            {["theoryapplied1", "theoryapplied2"].map(name => (
              <div key={name} style={{ borderRadius: "14px", overflow: "hidden", border: "1px solid rgba(255,255,255,0.08)", background: "rgba(255,255,255,0.02)", aspectRatio: "16 / 9" }}>
                <video autoPlay loop muted playsInline preload="auto" style={{ width: "100%", height: "100%", display: "block", objectFit: "cover", background: "#0b0b0b" }}>
                  <source src={`/tanoseilogos/${name}.mp4`} type="video/mp4" />
                </video>
              </div>
            ))}
          </div>
